...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGI5MjYiLCJhIjoiY2s3c3N5dmZjMHBqeDNmcXR1b2owajZuMiJ9.OIpYVKy4pDcZQ21cC1FzoQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/db926/ck7st4n6s0pbg1irrh2tlvcur',
    scrollZoom: false //   center: [-118.091956, 34.06119],
    //   zoom: 10,
    //   interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " : ").concat(loc.description, "</p>")).addTo(map); // Extedn the map bound to extend the current loaction
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_mAVYxUqQF3V074Z6gOmM5cca00Iezsc5hE');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'GET',
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // in js data-tour-id is convergte to data-tourId i.e. cammel case notaion after - in dataset name
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "21466" + '/');
